...
public class HttpClientUtils {
    ...
    public static String executeRequest(HttpUriRequest httpRequest, String jsonStr, String charset) throws IOException {
        CloseableHttpClient httpclient;
        if ("https".equals(httpRequest.getURI().getScheme())) {
            httpclient = createSSLInsecureClient();
        } else {
        ...
        response.close();
        httpclient.close();
        LogUtil.info("发起请求:"+ httpRequest.getURI() +",参数:"+ jsonStr +"，结果："+ result);
        return result;
    }
