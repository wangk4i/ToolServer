...
layui.define(['laytpl', 'layer'], function(exports){
  ...
  ,getCaption1 = function (obj) {
      ...
      srchash = "#/"+srchash;
      var title=layui.router(srchash).search.title;
      if(title==undefined){
         return '新标签页';
      }
      if(title.length==0){
  ...
  Class.prototype.render = function(views, params){
    ...
    //暂定url中以$分隔路由与参数，屏蔽路由中$后的参数后，加载模板资源
    var splitindex=views.indexOf("$");
    if(splitindex>-1){
      views=views.substring(0,splitindex);
    }
