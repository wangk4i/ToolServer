...
(function (t) {
    if ("function" == typeof define && define.amd) define(["$", "velocity"], t); else {
    ...
    }, s = "bellows__item", l = "bellows--is-open", r = "bellows--is-opening", a = "bellows--is-closing", p = {
    ...
    return i.VERSION = "2.0.0", i.DEFAULTS = {
        ...
        e in this.options && this.options[e].call(this, t.Event(o + ":" + e, {bubbles: !1}), i)
    }, i.prototype.toggle = function (t) {
        t = this._item(t), this[t.hasClass(l) ? "close" : "open"](t)
    }, i.prototype.open = function (t) {
        if (t = this._item(t), !t.hasClass(l)) {
            var i = this, o = t.find(p.ITEM_CONTENT_WRAPPER);
            this.options.singleItemOpen && this.closeAll(), this._trigger("open", {item: t}), e.animate(o, "slideDown", {
                begin: function () {
                    ...
                    t.removeClass(r).addClass(l).attr("aria-hidden", !0), i._setHeight(), i._trigger("opened", {item: t})
                }
            })
        }
        ...
        if (t = this._item(t), t.hasClass(l)) {
            var i = this, o = t.find(p.ITEM_CONTENT_WRAPPER);
            this._trigger("close", {item: t}), e.animate(o, "slideUp", {
                begin: function () {
                    i._setHeight(i._getHeight(i.$bellows)), t.removeClass(l).addClass(a)
                }, duration: this.options.duration, easing: this.options.easing, complete: function () {
                    t.removeClass(a).removeAttr("aria-hidden"), i._setHeight(), i._trigger("closed", {item: t})
                }
            })
        }
